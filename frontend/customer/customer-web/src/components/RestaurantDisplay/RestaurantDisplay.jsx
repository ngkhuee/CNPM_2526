...
const RestaurantDisplay = ({ filterBy = "category", filterValue = "All", showFilter = true }) => {
    ...
    useEffect(() => {setSelectedFilter(filterValue);}, [filterValue]);
    ...
    filteredRestaurants = [...restaurant_list].sort(
        (a, b) => getDistance(a.location, userLocation) - getDistance(b.location, userLocation)
    );
    } 
    ...
    filteredRestaurants = restaurant_list.filter(r => r.category === selectedFilter);
    }
