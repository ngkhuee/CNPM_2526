...
const Orders = ({ restaurantId }) => {
  const { orders, updateOrderStatus, updateDroneStatus } =
      ...
      <ul>
        {myOrders.map((o) => (
          <li key={o._id}>
            ...
            <button onClick={() => updateOrderStatus(o._id, "ready")}>
              Set Ready
            </button>
            <button onClick={() => updateDroneStatus(o._id, "picked_up")}>
              Drone Picked
            </button>
            <button onClick={() => updateDroneStatus(o._id, "delivered")}>
              Drone Delivered
            </button>
          </li>
        ))}
